...
import { deliverOptions, getDeliveryOption } from '../../data/deliverOptions.js';
...
export function renderOrderSummury() {
  ...
  function deliverOptionsHTML(matchingProduct, cartItem) {
    ...
    deliverOptions.forEach((deliverOption) => {
      ...
      html += `
        <div class="delivery-option js-delivery-option" data-product-id="${matchingProduct.id}" data-deliver-option-id="${deliverOption.id}">
